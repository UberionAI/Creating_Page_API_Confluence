...
func main() {
	...
	titleFlag := flag.String("title", "", "Optional page title (default: Паспорт Вм: <hostname>)")
	...
	if *titleFlag != "" {
		...
		page.Title = fmt.Sprintf("Паспорт Вм: %s", page.Hostname)
	} else {
		page.Title = fmt.Sprintf("Паспорт Вм: %s", cfg.SSHHostname)
	}
...
<table class="wrapped">
  ...
  <tbody>
    ...
    <tr>
      <td><strong>Команда-владелец</strong></td>
      <td><br /></td>
    </tr>
    <tr>
      <td><strong>Краткое назначение</strong></td>
      <td><br /></td>
    </tr>
    <tr>
...
<table class="wrapped">
  ...
  <tbody>
    <tr>
      <td>SSH</td>
      <td><ac:placeholder>ssh user@hostname</ac:placeholder></td>
    </tr>
    <tr>
      <td>Web-UI</td>
      <td><ac:placeholder>https://hostname.example.com</ac:placeholder></td>
    </tr>
    <tr>
      <td>API</td>
      <td><ac:placeholder>https://hostname.example.com/api</ac:placeholder></td>
    </tr>
  </tbody>
</table>
...
<h2>Метрики и пороги (SLI → SLO)</h2>
<table class="wrapped">
  <colgroup>
    <col style="width: 25.0%;" />
  ...
  <tbody>
    <tr>
      <td>CPU Usage</td>
      <td><ac:placeholder></ac:placeholder></td>
      <td><br /></td>
      <td><br /></td>
      <td><br /></td>
    </tr>
...
<h2>Быстрый self-check</h2>
<ac:structured-macro ac:name="expand" ac:schema-version="1">
  <ac:parameter ac:name="title">Пошаговый рецепт для инженера</ac:parameter>
  <ac:rich-text-body>
    <ol>
      <li><br /></li>
    </ol>
